...
const Footer = () => {
    return (
        ...
        <footer className="py-6 dark:bg-sky-900 dark:text-gray-50">
            <div className="container px-3 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-6 divide-opacity-50">
